...
describe("MergedScoreComponent", () => {
    ...
    it("assigns its values from the highest result component", () => {
        ...
        expect(mergedComponent).to.have.property("id", 2);
    ...
    it("assigns values from first component when second is null", () => {
        const mergedComponent: MergedScoreComponent = new MergedScoreComponent(component1, null);
        expect(mergedComponent).to.have.property("id", 1);
    ...
    it("throws error when first component is null", () => {
        expect(() => { new MergedScoreComponent(null, null) }).to.throw("First component is null");
    });
    ...
    it("throws error when first and second have different type", () => {
        ...
        expect(() => new MergedScoreComponent(component1, component2)).to.throw("Type of first and second component is different");
    })
